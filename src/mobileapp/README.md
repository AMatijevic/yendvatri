...
```sh
# with bun
bun create expo-app mobileapp --template https://github.com/kadikraman/expo-starter

# with npm
npx create-expo-app mobileapp --template https://github.com/kadikraman/expo-starter
```
